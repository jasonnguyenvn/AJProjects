...
public class ProcessServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String txtPrice = request.getParameter("txtPrice").trim();
            try {
            ...
            String txtCode = request.getParameter("txtCode").trim();
            String txtName = request.getParameter("txtName").trim();
            String txtDescription = request.getParameter("txtDescription").trim();
            String cbCategory = request.getParameter("cbCategory").trim();
            
            Product newProduct = new Product(txtCode, txtName, txtDescription, 
                                                productPrice, cbCategory);
            
            boolean result = false;
            try {
                result = ProductDAO.saveProduct(newProduct);
            ...
            request.setAttribute("SAVEDPRODUCT", newProduct);
            
            RequestDispatcher dis = request
                                    .getRequestDispatcher("showSavedProServlet");

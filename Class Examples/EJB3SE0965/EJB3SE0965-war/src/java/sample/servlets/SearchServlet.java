...
import sample.sesssions.LoginSessionBeanLocal;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                Object obj = context.lookup("LoginLocalJNDI");
                LoginSessionBeanLocal poji = (LoginSessionBeanLocal) obj;
                
                
                try {
                    List<UserDTO> userList = poji.searchByLastName(txtSearchValue);
